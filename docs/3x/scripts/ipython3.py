...
def main():
    ...
    ipshell("""IPython 6.2.1 - An enhanced Interactive Python
...
try:
    import platform
    if int(''.join(platform.python_version().split('.')[:-1]))<36:

        op(__doc__)
        op("You must switch to Python3.6, please install QPY36 from App market")
    else:
